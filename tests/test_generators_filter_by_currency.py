...
def test_filter_by_currency_dollar(transactions_fixture):
    assert list(filter_by_currency(transactions_fixture, "USD")) == [
        {
            "id": 939719570,
            "state": "EXECUTED",
